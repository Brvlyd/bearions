...
const translations: Translations = {
  ...
  'cart.emptyDescription': { en: 'Add some items to your cart to get started!', id: 'Tambahkan beberapa item ke keranjang untuk memulai!' },
  'cart.browseProducts': { en: 'Browse Products', id: 'Lihat Produk' },
  'cart.loading': { en: 'Loading cart...', id: 'Memuat keranjang...' },
